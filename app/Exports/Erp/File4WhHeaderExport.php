...
class File4WhHeaderExport implements FromCollection, WithHeadings, WithMapping
{
    protected $items;
    ...
    public function map($row): array
    {
        ...
        return [
            ...
            $row->item_group_child,         // Item Group (child)
            '',
            ...
            0,
            0,
            $row->unit_child,               // Expected Annual Issue (child)
            'Not Applicable',
            '',
            'C',
            'C',
